...
pub fn create_browser_config_with_instance_id(config: &Config, instance_id: Option<usize>) -> chromiumoxide::browser::BrowserConfig {
    ...
    builder.build().unwrap_or_else(|_| BrowserConfig::with_executable("/usr/sbin/chromium"))
}