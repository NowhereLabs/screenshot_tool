...
impl ScreenshotError {
    pub fn is_retryable(&self) -> bool {
        matches!(self, ScreenshotError::BrowserUnavailable | ScreenshotError::UrlLoadFailed(_) | ScreenshotError::NetworkError(_) | ScreenshotError::Timeout(_) | ScreenshotError::PageError(_) | ScreenshotError::BrowserProcessDied(_))
    }
